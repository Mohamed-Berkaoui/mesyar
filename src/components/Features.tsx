      ...
      <div className="features-container">
        ...
        >
          ...
          <p className="features-intro">
            في المساير صممنا خدماتنا لضمان وصول الحلول المناسبة في العدد المحدد من مزايا النقل الفردي والنقل الجماعي التي تخفض التكاليف وترفع كفاءة التشغيل للمطاعم والمسالخ وطلبة الخدمة.
          </p>
